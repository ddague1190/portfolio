                ...
                <header className=''>
                    ...
                    <span className="relative z-0 inline-flex shadow-sm rounded-md">
                        <div className="relative">
                            <button type="button" className="relative inline-flex items-center px-4 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-[#43bdff] focus:border-[#43bdff]" onClick={copyToClipboard.bind(null, 'me@darryldague.dev')}>Copy email</button>
                            {copied &&
                        ...
                        >
                        <button type="button" className="-ml-px relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-[#43bdff] focus:border-[#43bdff]">
                        ...
                        <button type="button" className="-ml-px relative inline-flex items-center px-4 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-[#43bdff] focus:border-[#43bdff]">
                            resume.pdf
                        </button>
                        </Link>
                    </span>
