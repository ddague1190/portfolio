                ...
                <header className=''>
                    ...
                    <dl className='flex items-center gap-4 w-full'>
                        ...
                        <dl className="cursor-pointer">
                            <a target="_blank" href='https://github.com/ddague1190'>
                ...
                <section className="mb-2">
                    ...
                    <details className="mb-1" open>
                        <summary className="list-none font-semibold tracking-tighter">FishNStik
                            <a target="_blank" className='tracking-normal font-normal ml-1' href="https://fishnstik.herokuapp.com">(https://fishnstik.herokuapp.com)</a>
