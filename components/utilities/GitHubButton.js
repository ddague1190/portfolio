    ...
    return (
        <span className="absolute z-50 w-max top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 inline-flex shadow-sm rounded-md">
            <Link
                href={links[0]}
                type="button"
                className="cursor-pointer hover:bg-gray-50 relative inline-flex tracing-tighter font-bold items-center px-4 py-2 rounded-l-md border border-gray-300 bg-white text-sm  text-gray-700  focus:z-10 focus:outline-none focus:ring-1"
            >
                Go to website
            </Link>
            {youTubeLink &&
            ...
            <Link
                href={links[1]}
                type="button"
                className="-ml-px  hover:bg-green-50 bg-blue-100 cursor-pointer relative inline-flex items-center px-3 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-700  focus:z-10 focus:outline-none focus:ring-1"
            >
